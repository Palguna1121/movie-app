...
const Popular = () => {
  ...
  useEffect(() => {
    fetch(`https://api.themoviedb.org/3/tv/on_the_air?api_key=${API_KEY}&page=${currentPage}`)
    ...
    <>
      ...
      <section>
        <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
          <HeaderMenu title={"On The Air"} subTitle={"Nikmati film yang ramai dibicarakan, serial populer, dan lainnya"} />
